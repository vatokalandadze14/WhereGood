...
namespace HouseOwnerWebApi.Services
{
    public class InterierCompanyService : IInterierCompanyService
    {
        ...
        public InterierCompanyService(DataContext context, IInterierCompanyInterface repostiroy)
        {
            _context = context;
        ...
        {
            return await _repostiroy.GetAllAsync();
        }
        public async Task<InterierCompany> GetInterierCompany(Guid id)
        {
            return await _repostiroy.GetSingleAsync(id);
        }
        ...
        {
            return await _repostiroy.DeleteAsync(id);
        }
    }
}
